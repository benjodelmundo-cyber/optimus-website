...
export function Header() {
  return <header className="site-header"><Link className="brand" href="/"><img src="/images/optimus-logo-clean.png" alt=""/><span><b>OPTIMUS</b><small>Defense & Sports Enterprise</small></span></Link><nav className="desktop-nav" aria-label="Main navigation"><Link href="/services">Services</Link><Link href="/our-work">Our Work</Link><Link href="/about">About</Link><Link href="/process">Process</Link><Link href="/contact">Contact</Link></nav><Link className="button compact header-cta" href="/request-a-consultation">Request consultation</Link><MobileNav/></header>;
}

export function Footer() {
  return <footer><div><div className="footer-identity"><img src="/images/optimus-logo-clean.png" alt="Optimus lion shield"/><div className="footer-brand"><strong>OPTIMUS</strong><span>DEFENSE AND SPORTS ENTERPRISE</span></div></div><p>Precision built. Performance inspired.</p></div><div><h3>Visit</h3><p>{site.address}</p><p>{site.hours}</p></div><div><h3>Explore</h3><p><Link href="/services">Services</Link> · <Link href="/our-work">Our work</Link> · <Link href="/faq">FAQ</Link></p><p><Link href="/privacy">Privacy</Link> · <Link href="/terms">Terms</Link> · <Link href="/disclaimer">Disclaimer</Link></p></div><p className="footer-note">© {new Date().getFullYear()} Optimus Defense and Sports Enterprise. All rights reserved.</p></footer>;
}
