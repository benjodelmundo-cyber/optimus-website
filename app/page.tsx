...
export default function Home() {
  return <Shell>
    <section className="hero">
      ...
      <div className="hero-shade"/><div className="hero-brand-lockup" aria-hidden="true"><img className="hero-logo" src="/images/optimus-logo-hero-tight.png" alt=""/><img className="hero-wordmark" src="/images/optimus-official-wordmark-v3.png" alt=""/></div><div className="hero-copy"><p className="eyebrow">{site.name} · Lipa City</p><h1>Expert.<br/>Dependable.<br/><em>Built around you.</em></h1><p>Precision gunsmithing, competition preparation, restoration and premium customization—guided by inspection, craftsmanship and clear expectations.</p><div className="actions"><Link className="button" href="/request-a-consultation">Request a consultation</Link><Link className="button secondary" href="/our-work">View our work</Link></div></div>
    ...
    <section className="section"><div className="section-heading"><div><h2>Craftsmanship in the details.</h2></div><Link className="text-link" href="/our-work">View the full portfolio →</Link></div><div className="project-grid">{projects.slice(0,3).map((p,i)=><article className={`project-card project-${i}`} key={p.title}><img src={p.image} alt={p.alt}/><div><h3>{p.title}</h3></div></article>)}</div></section>
