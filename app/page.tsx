...
export default function Home() {
  return <Shell>
    <section className="hero">
      ...
      <div className="hero-shade"/><div className="hero-brand-lockup" aria-hidden="true"><img className="hero-logo" src="/images/optimus-logo-clean.png" alt=""/><img className="hero-wordmark" src="/images/optimus-official-wordmark-v3.png" alt=""/></div><div className="hero-copy"><p className="eyebrow">{site.name} · Lipa City</p><h1>Expert.<br/>Dependable.<br/><em>Built around you.</em></h1><p>Precision gunsmithing, competition preparation, restoration and premium customization—guided by inspection, craftsmanship and clear expectations.</p><div className="actions"><Link className="button" href="/request-a-consultation">Request a consultation</Link><Link className="button secondary" href="/our-work">View our work</Link></div></div>
